...
# corresponding name will OUTPUT_DIRbe post-fixed by a _TRAIN for a training parameter,
...
_C.MODEL.DOMAIN_ADAPTATION_MASK_ON =False
_C.MODEL.ENT_WEIGHTED_ON =False
_C.MODEL.ENT_WEIGHTED_ON_RPN =False
_C.MODEL.ENT_WEIGHTED_ON_RCNN_INTER =False
