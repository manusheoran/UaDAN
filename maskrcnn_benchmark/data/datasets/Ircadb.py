...
from maskrcnn_benchmark.data.datasets.load_ct_img_ircadb import load_prep_img
...
class ircadbDataset(object):
    ...
    def __init__(
        ...
        ann_file = "/data/nihcc/FCOS/csv_files_datasets/ircadb_test.csv"  #kits_train, kits_keyslice_test, ircadb_fewshot_3patients, ircadb_uda
        ...
        self.logger.info('Ircadb %s num_images: %d' % (split, self.num_images))
