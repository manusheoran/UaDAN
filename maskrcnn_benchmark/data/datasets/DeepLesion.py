...
from maskrcnn_benchmark.data.datasets.load_ct_img import load_prep_img
...
class DeepLesionDataset(object):
    ...
    def __init__(
        ...
        ann_file = "/data/nihcc/FCOS/csv_files_datasets/DL_info_all.csv"  #DL_train_liver, DL_info_all
