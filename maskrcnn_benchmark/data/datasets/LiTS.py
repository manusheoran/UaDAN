...
from maskrcnn_benchmark.data.datasets.load_ct_img_lits import load_prep_img
...
class LiTSDataset(object):
    ...
    def __init__(
        ...
        ann_file = "/data/nihcc/FCOS/csv_files_datasets/lits_train.csv" #lits_test.csv, lits_train
...
#                 self._process_manual_annot_test_tags()
    ...
    def __getitem__(self, index):
        ...
        infos = {'im_index': index, 'lesion_idxs': lesion_idx_grouped, 'image_fn': image_fn, 
                 'crop': crop,  'slice_intv': slice_intv, 'im_scale': im_scale, 'spacing' : spacing}
